...
This project is indexed by GitNexus as **danwa** (7946 symbols, 12780 relationships, 651 execution flows).
...
| Resource | Use for |
| --- | --- |
| `gitnexus://repo/danwa/context` | Codebase overview, check index freshness |
| `gitnexus://repo/danwa/clusters` | All functional areas |
| `gitnexus://repo/danwa/processes` | All execution flows |
| `gitnexus://repo/danwa/process/{name}` | Step-by-step execution trace |
